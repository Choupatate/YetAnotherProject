...
def test_highlight_renders_as_mark():
    html = render_markdown("This is ==important==.", "2026-01-01-story")
    assert "<mark>important</mark>" in html


def test_lone_image_wrapped_in_figure_with_caption():
    html = render_markdown("![The big moment](photo-001.jpg)", "2026-01-01-story")
...
def test_image_without_alt_has_no_figcaption():
    html = render_markdown("![](photo-002.jpg)", "2026-01-01-story")
    assert "<figure>" in html
    assert "<figcaption>" not in html


def test_absolute_image_src_not_rewritten():
    html = render_markdown("![alt](https://example.com/photo.jpg)", "2026-01-01-story")
...
def test_basic_paragraph_and_emphasis():
    html = render_markdown("Hello *world*.", "2026-01-01-story")
